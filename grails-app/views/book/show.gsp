	...
	<body>
		...
		<div id="show-book" class="content scaffold-show" role="main">
			...
			<ol class="property-list book">
				...
				<g:if test="${bookInstance?.bookReleaseDate}">
				<li class="fieldcontain">
					<span id="bookReleaseDate-label" class="property-label"><g:message code="book.bookReleaseDate.label" default="Book Release Date" /></span>
					
						<span class="property-value" aria-labelledby="bookReleaseDate-label"><g:fieldValue bean="${bookInstance}" field="bookReleaseDate" /></span>
