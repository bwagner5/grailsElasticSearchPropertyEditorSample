		...
		<div id="list-book" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="bookReleaseDate" title="${message(code: 'book.bookReleaseDate.label', default: 'Book Release Date')}" />
				...
				<g:each in="${bookInstanceList}" status="i" var="bookInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:formatDate date="${bookInstance.bookReleaseDate}" /></td>
